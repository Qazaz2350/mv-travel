...
import 'package:mvtravel/view_model/filters_viewmodel.dart'; // same ViewModel
import 'package:provider/provider.dart';
import 'package:mvtravel/utilis/FontSizes.dart';
import 'package:mvtravel/utilis/colors.dart';

class TravelFiltersScreen extends StatelessWidget {
  const TravelFiltersScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                      ...
                      hint: 'Keywords / Destination',
                      icon: Icons.search,
                    ),
                    SizedBox(height: 16.h),

                    // Departure Location + Distance
                    Row(
                      children: [
                        Expanded(
                          flex: 2,
