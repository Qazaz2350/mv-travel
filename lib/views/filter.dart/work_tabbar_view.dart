                ...
                child: Column(
                  ...
                  children: [
                    _buildTextField(
                      ...
                      hint: 'Keywords / Job Title / Job Ref',
                      icon: Icons.search,
                    ),
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _buildDropdownField(
                            hint: vm.selectedSalaryType,
                            onTap: () => _showPicker(
                              context,
                              'Select Salary Type',
                              vm.salaryTypeOptions,
                              vm.selectedSalaryType,
                              vm.setSalaryType,
                            ),
                          ),
                        ),
            ...
            Expanded(
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: (hint == 'Salary Type' || hint == 'Job Type')
                      ? AppColors.grey2
                      : AppColors.black,
                ),
              ),
